...
//
// Same helper as homerun2-omni-pitcher's internal/pitcher/wait.go; keep the
// two in step until it moves into homerun-library.
...
// seconds away from ready crashloops the pod (#117).
